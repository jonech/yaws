...
namespace yaws.Notification
{
    public class WorldStateProcess
    {
        ...
        private bool ProcessSingleExpirable(NotificationState state, IExpirable expirableStat, string statType)
        {
            ...
            if (state.WfStatId == expirableStat.Id || expirableStat.Expiry.IsExpired())
            {
